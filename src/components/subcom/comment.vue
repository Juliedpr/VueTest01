...
export default {
    ...
    created(){
        ...
        // this.list = [
            // {
            //     "user_name": "匿名用户",
            //     "add_time": "2017-08-15T13:30:24.000Z",
            //     "content": "前(⊙o⊙)…3额"
            //     },
            //     {
            //     "user_name": "匿名用户",
            //     "add_time": "2017-08-15T13:30:11.000Z",
            //     "content": "去问问"
            //     }
        // ]
    },
    methods: {
        //3.0 实现加载更多的方法
        getmore(){
            // 3.0.1 实现this.pageindex值的增加1
            this.pageindex++;
            //3.0.2 获取当前this.pageindex值对应的分页数据
            this.getcommentlist(this.pageindex);
        },
        //2.0 获取当前数据的评论数据
        getcommentlist(pageindex){ //pageindex代表的是当前获取的是哪一页的数据，默认值是1
